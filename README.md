...
- Your own domain (e.g., `fdroid.gyorffi.hu`)
...
**Update `config.yml`** if needed (domain is already set to `fdroid.gyorffi.hu`).
...
2. Add repository: `https://fdroid.gyorffi.hu/repo`
